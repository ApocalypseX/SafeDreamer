...
class SafetyGymMujoco(embodied.Env):
  ...
  def __init__(self, env, repeat=1, obs_key='observation', render=False, size=(64, 64), mode='train', camera_name='vision'):
    ...
    env = safety_gymnasium.make(env,render_mode='rgb_array', width=size[0], height=size[1], terminate_when_unhealthy=True)
